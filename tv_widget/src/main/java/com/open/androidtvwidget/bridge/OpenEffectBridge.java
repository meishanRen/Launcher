...
public class OpenEffectBridge extends BaseEffectBridgeWrapper {
    ...
    private static final int DEFUALT_TRAN_DUR_ANIM = 0;
    ...
    public interface NewAnimatorListener {
        void onAnimationStart(OpenEffectBridge bridge, View view, Animator animation);

        void onAnimationEnd(OpenEffectBridge bridge, View view, Animator animation);
    }
    ...
    public void flyWhiteBorder(final View focusView, float x, float y, float scaleX, float scaleY) {
        ...
        if (focusView != null) {
            float a = x;
            newWidth = Math.round(focusView.getMeasuredWidth() * scaleX);
            Log.d("runrun", "newwidth" + newWidth);
